...
public class Puzzle70 : MonoBehaviour
{
	public Image num1;
	public Image num2;
	public Image num37;
	...
	void Update(){
		...
		if(distance >= 48 && distance <=54 && num1.IsActive() && num2.IsActive()){
		...
		if(distancex >= -53 && distancex <=-46 && distancey>=-9.5 && distancey <=-2.5 && num1.IsActive() && num2.IsActive()){
